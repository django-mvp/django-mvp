...
means for contrast, the full variable reference, why the theme plugin computes
nothing, why your own theme wins regardless of load order, and a worked example of
